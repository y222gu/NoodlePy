...
def configure_path():
    print("Configuring path within windows_setup.py...")
    is_64bits = sys.maxsize > 2**32
    relative_path_to_dlls = '..' + os.sep + 'DiddyKong' + os.sep + 'dlls' + os.sep
    ...
    # relative_path_to_dlls += os.sep + 'Python Toolkit'
    ...
    print("absolute_path_to_dlls is: " + absolute_path_to_dlls)
