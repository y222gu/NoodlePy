...
if __name__ == "__main__":
    ...
    wandb.init(
        project="SimSiam", 
        name=f"2025_2_26_HNC_plasma_augmented_then_preprocessed_high_intensity_cleaned_data", 
    ...
    plasma_train_dataset_path = os.path.join(os.getcwd(), "noodlepy", "data", "hnc_raw_data_high_quality")
    ...
    ##### NAME OF THE MODEL
    exp_name = "2025_2_26_HNC_plasma_augmented_then_preprocessed_high_intensity_cleaned_data"
    experiment_folder = os.path.join(os.getcwd(), "output_plots")
    wandb.run.name = exp_name

    # #### LOAD A SAVED MODEL
    # model.load_state_dict(torch.load(os.path.join(os.getcwd(), "output_plots", "2025_2_26_HNC_plasma_augmented_then_preprocessed_high_intensity_cleaned_data.pth")))
