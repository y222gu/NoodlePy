...
class StageControlerModule(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        self.connect_button = ttk.Button(top_frame, text="Connect", command=self.connect_device, bootstyle="info-outline")
        ...
        ttk.Button(reference_frame, text="Ref X", command=lambda: self.ref("X"), bootstyle="info-outline", width=6).grid(row=0, column=0, padx=5)
        ttk.Button(reference_frame, text="Ref Y", command=lambda: self.ref("Y"), bootstyle="info-outline", width=6).grid(row=0, column=1, padx=5)
        ttk.Button(reference_frame, text="Ref Z", command=lambda: self.ref("Z"), bootstyle="info-outline", width=6).grid(row=0, column=2, padx=5)
        ttk.Button(reference_frame, text="Ref All", command=lambda: self.ref("ALL"), bootstyle="info", width=6).grid(row=0, column=3, padx=5)
        ...
        self.register_first_smaple_button = ttk.Button(register_frame, text="Register Current Position as First Sample", command = self.register_first_smaple, bootstyle ="info", width=36)
        self.register_first_smaple_button.grid(row=0, column=1, padx=5, pady=5)
        self.register_lowest_point_button = ttk.Button(register_frame, text="Register Current Z as the Lowest Point", command=self.register_lowest_point, bootstyle = "info", width=36)
        ...
        self.go_to_first_sample_button = ttk.Button(register_frame, text="Go", command=self.go_to_first_sample, bootstyle="light", width=6, state=DISABLED)
        self.go_to_first_sample_button.grid(row=0, column=3, padx=5, pady=5)
        self.go_to_lowest_point_button = ttk.Button(register_frame, text="Go", command=self.go_to_lowest_point, bootstyle="light", width=6, state=DISABLED)
    ...
    def connect_device(self):
        ...
        if printer_status:
            ...
            self.connect_button.configure(bootstyle="info")
    ...
    def disconnect_device(self):
        ...
        self.connect_button.configure(bootstyle="info-outline")
        self.port = None
        self.ser = None
    ...
    def register_first_smaple(self):
        ...
        self.register_first_smaple_button.configure(bootstyle="light")
    ...
    def register_lowest_point(self):
        ...
        self.register_lowest_point_button.configure(bootstyle="light")
    ...
    def remove_lowest_point_registration(self):
        ...
        self.register_lowest_point_button.configure(text ='Register Current Z as the Lowest Point', state = NORMAL, bootstyle = 'light')
...
class AutoFocusModule(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        button = ttk.Button(main_frame, text="Coarse Focus", command=self.autofocus, bootstyle="info-outline", width=15)
        button.grid(row=2, column=2, padx=5, pady=5)

        # Create the button to stop autofocus
        button = ttk.Button(main_frame, text="Fine Focus", command=self.autofocus, bootstyle="info-outline", width=15)
        button.grid(row=3, column=2, padx=5, pady=5)

        # Create the button to save the autofocus results
        button = ttk.Button(main_frame, text="Run Both", command=self.autofocus, bootstyle="info", width=15)
        button.grid(row=4, column=2, columnspan=3, padx=5, pady=5)

        button = ttk.Button(main_frame, text="Stop", command=self.stop_autofocus, bootstyle="warning", width=15)
