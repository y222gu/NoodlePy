...
class AcquisitionGUI(ttk.Frame):
    ...
    def create_widgets(self):
        ...
        acquisition_protocol_frame.add_subscriber('move_stage_to_target_sample_drop_during_aquisition', stage_control_frame, callback = stage_control_frame.handle_move_stage_to_target_sample_drop_during_aquisition_in_widefield_view)
        acquisition_protocol_frame.add_subscriber('focus_widefield_camera', stage_control_frame, callback = stage_control_frame.handle_focus_widefield_camera)
        ...
        acquisition_protocol_frame.add_subscriber('call_switch_view_button_in_live_camera_module', live_view_frame, live_view_frame.on_switch_view_button_clicked)
        acquisition_protocol_frame.add_subscriber('move_to_a_single_sampling_point', stage_control_frame, callback = stage_control_frame.handle_move_to_a_single_sampling_point)
        acquisition_protocol_frame.add_subscriber('focus_objective_camera', stage_control_frame, callback = stage_control_frame.handle_focus_objective_camera)
        acquisition_protocol_frame.add_subscriber('focus_wasatch', wasatch_autofocus_frame, callback = wasatch_autofocus_frame.start_autofocus)
        ...
        acquisition_protocol_frame.add_subscriber('reposition_stage_and_nanodrive_in_objective_view', stage_control_frame, callback = stage_control_frame.handle_reposition_stage_and_nanodrive_in_objective_view)
